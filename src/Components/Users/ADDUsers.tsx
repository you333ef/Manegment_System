...
const Users = () => {
  ...
  if(location.state && location.state.user){
    let userupdateid=location.state.user
  try {
    let response=axios.put(`https://dummyjson.com/users/${userupdateid.id}`,data)
  ...
  , 2000);
    ...
    try {
      let response=axios.post('https://dummyjson.com/users/add',data)
      console.log(response)
